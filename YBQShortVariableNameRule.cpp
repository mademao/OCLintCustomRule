...
class YBQShortVariableNameRule : public AbstractASTVisitorRule<YBQShortVariableNameRule>
{
private:
...
public:
    ...
    {
        return "YBQ short variable name";
    }
    ...
    bool VisitVarDecl(VarDecl *varDecl)
    {
        ...
        string varType = varDecl->getType().getAsString();
        ...
        //排除CGFloat类型的x，y
        if (varType == "CGFloat" && (varName == "x" || varName == "y")) {
            return true;
        }
...
static RuleSet rules(new YBQShortVariableNameRule());
